		...
		<div id="formWrapper">
			<div id="mainFormDiv">
				<?php echo form_open($this->uri->uri_string()) ?>
					...
					<input type="text" id="titleInput" class="textInput" name="articleTitle" value=""/>
					
					<label for="articleContent">Artikel</label>
					<br>
					<textarea id="contentInput" name="articleContent"></textarea>
					<br>
					<!--<label for="metaKw">Schlüsselwörter</label>
					<input id="metaKwInput" class="textInput" name="metaKw" value=""/>
					
					<label for="metaDesc">Seitenbeschreibung</label>
					<textarea id="metaDescInput" name="metaDesc"></textarea>-->
					
					<input type="submit" name="submit" value="Abschicken" class="btn btn-success"/>
					<a href="pages" class="btn btn-default">Abbrechen</a>
				</form>
			</div>
			<div id="sideFormDiv">
...
<script type="text/javascript" src="<?= assets_url().'plugins/tinymce/tinymce.min.js' ?>"></script>
